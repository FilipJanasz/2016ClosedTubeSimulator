function plotter_mat_manual(default_dir)
    ...
    if userChoice==1
        ...
        %string in the name
        [directory, processed_files_list]=fileFinder('processed',1,default_dir);
...
%         mat_files=cellfun(@(x)regexp(x,'processed'),file_names,'UniformOutput', false);
% 
