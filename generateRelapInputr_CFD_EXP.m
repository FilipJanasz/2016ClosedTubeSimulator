...
%% INPUT----------------------------------------------------
    ...
    %Timing
    action_start=0; %[s] - when coolant water will start to flow and when heater will start to heat
...
%     condenser_vol=pi*tube_inner_diam*condenser_length; % [m^3]
    ...
    condenser_horizontal_cells=4;  %XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
%                             Tss=Tps-Superheat(Superheat_count); % EXP% EXP% EXP% EXP% EXP% EXP% EXP% EXP% EXP
...
%                             SecondaryTemp=num2str(Tss(Superheat_count)); % EXP% EXP% EXP% EXP% EXP% EXP% EXP% EXP% EXP
...
%                                 fprintf(fid,'%s  0.      0.                       %s \n',num2str(current_tube_no+2301),amount_of_tube_parts);
                                ...
                                fprintf(fid,'%s  0100000                          %s \n',num2str(current_tube_no+1101), tube_minus_one);   
                                %if clause to change initial conditions
                                %between pure steam and NC calculations
                                if NC(NC_count)== 0 
                                    fprintf(fid,'*CCC1201 ebt  press  stat_qual         vol.no.\n');
                                    fprintf(fid,'%s       002  %s.    1.     0.  0.  0.     %s \n',num2str(current_tube_no+1201),PrimaryPressure, amount_of_tube_parts); %****************************************************
                                else
...
%                             fprintf(fid,'11201000  %s     5       2    0         %s \n', amount_of_adiabatic_parts, condenser_unit_radius_inner);
                            fprintf(fid,'*         mesh flag  format\n');
                            fprintf(fid,'11201100  0          1\n');
                            fprintf(fid,'*         intvl   right.cord.\n');
                            fprintf(fid,'11201101  4       %s \n', radius_outer);
%                             fprintf(fid,'11201101  4       %s \n', condenser_unit_radius_outer);
                            fprintf(fid,'*         comp    intvl\n');
...
%                             fprintf(fid,'11211000  %s     5       2    0         %s \n', amount_of_coolant_water, condenser_unit_radius_inner);
                            fprintf(fid,'*         mesh flag  format\n');
